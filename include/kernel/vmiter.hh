...
class vmiter {
  public:
    ...
    inline vmiter(pagetable* pt, uintptr_t va = 0);
  ...
  private:
    ...
    static const pageentry_t zero_pe;
...
inline ptiter::ptiter(pagetable* pt)
    : pt_(pt) {
    go(0);
}
...
inline pagetable* ptiter::kptr() const {
